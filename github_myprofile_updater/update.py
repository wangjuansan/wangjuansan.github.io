if __name__ == '__main__':
    _header = "### Hi there, I'm [Juan Wang (王娟 in Chinese)](https://wangjuansan.github.io/)! 👋 You can also call me Jane."
    ...
    with open('README.md', 'w') as f:
        ...
        f.write(_intro)
        f.write('\n\n')
        f.write('Welcome to refer to my full publication list at [my personal homepage](https://wangjuansan.github.io/#-publications).')
        f.write('\n')
